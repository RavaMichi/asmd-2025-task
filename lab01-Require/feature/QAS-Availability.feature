...
Feature: Availability
    ...
    Background:
        ...
        And monitoring and an automatic-restart policy are enabled for the service

    Scenario: Server crash and automatic restart within 60 seconds
        Given the service is reachable and "<endpoint>" returns OK
        ...
        And the service becomes healthy again ("<endpoint>" returns OK)
